...
public class Update {
    ...
    public void waiterDevices(Connection connection) throws SQLException {
        ...
        PreparedStatement waiterDevices = connection.prepareStatement("UPDATE app_config SET waiter_devices = " + waiterdevices);
        waiterDevices.execute();
    }
}
