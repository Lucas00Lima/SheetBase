...
public class ProductFactory implements TreatmentRows {
    ...
    public Product produto(Sheet sheet, int rowIndex, Connection connection) {
        ...
        Cell ncmCell = row.getCell(10);
        Cell cfopCell = row.getCell(11);
        Cell cestCell = row.getCell(12);
        Cell cstCell = row.getCell(13);
        Cell icmsCell = row.getCell(14);
        Cell piscodCell = row.getCell(15);
        Cell pisCell = row.getCell(16);
        Cell cofinscodCell = row.getCell(17);
        Cell cofinsCell = row.getCell(18);
        Cell icmsRedCell = row.getCell(19);
        Cell currentStockCell = row.getCell(20);
        Cell measureUnitCell = row.getCell(21);
        Cell deliveryCell = row.getCell(22);
        Cell tableCell = row.getCell(23);
        Cell cardCell = row.getCell(24);
        Cell balconyCell = row.getCell(25);
        Cell statusCell = row.getCell(26);
        ...
        return new Product(internalCode, barcode, name, categoryId, description, price, type, type2, cost , ncm, cfop, cest, cst,
