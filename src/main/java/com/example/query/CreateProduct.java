...
public class CreateProduct {
    ...
    public void createProduct(Connection connection, Sheet sheet, int rowIndex) {
        try {
            ...
            preparedStatement.setInt(15, 0);//costValue);
            preparedStatement.setInt(16, 0);//markup);
            preparedStatement.setInt(17, 0);//minimum_stock);
            preparedStatement.setInt(18, 0);//currentStockValue);
            ...
            preparedStatement.setInt(41, 1);//active);
            preparedStatement.setNull(42, Types.DATE);//validity);
            preparedStatement.setInt(43, 1);//delivery);
            preparedStatement.setInt(44, 1);//card);
            preparedStatement.setInt(45, 1);//hall_table);
            preparedStatement.setInt(46, 1);//balcony);
